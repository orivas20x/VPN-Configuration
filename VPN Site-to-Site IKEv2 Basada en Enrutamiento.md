# VPN Site-to-Site IKEv2 Basada en Enrutamiento

---

## 1. Objetivo de la VPN

El objetivo de este laboratorio es implementar una VPN Site-to-Site basada en enrutamiento (Route-Based) usando **IPSec IKEv2**. Se crea una interfaz de túnel virtual (Tunnel0) con modo IPSec y se define una ruta estática para dirigir el tráfico. Combina la flexibilidad del Route-Based con las mejoras de IKEv2.
...
<img width="259" height="337" alt="Screenshot 2026-07-03 023324" src="https://github.com/user-attachments/assets/9103bce2-e388-45aa-a3f2-a6f5537625a5" />
...
### Fase 2 (IPSec Route-Based)

- **Transform-set:** ESP-AES y ESP-SHA-HMAC.
- **Modo:** Tunnel Mode.
- **Perfil IPSec:** VPNPROFILE (con `set ikev2-profile`).
- **Interfaz de Túnel:** Tunnel0 (172.16.24.0/30) — tunnel mode ipsec ipv4.
...
<img width="670" height="492" alt="Screenshot 2026-07-03 031529" src="https://github.com/user-attachments/assets/81067861-c497-4ec7-8836-c0786cc57633" />


### Verificación de Túnel Activo

<img width="667" height="499" alt="Screenshot 2026-07-03 031651" src="https://github.com/user-attachments/assets/05bdd886-037e-4653-8e03-26eb191714c5" />


<img width="668" height="499" alt="Screenshot 2026-07-03 031629" src="https://github.com/user-attachments/assets/4e2808c7-ac4b-4bab-9bfe-f0d438ae7e7f" />
